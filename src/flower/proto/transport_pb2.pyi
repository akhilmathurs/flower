    ...
    class FitRes(google___protobuf___message___Message):
        ...
        def __init__(self,
            *,
            ...
            gradients : typing___Optional[Parameters] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
        ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def HasField(self, field_name: typing_extensions___Literal[u"gradients",u"parameters"]) -> builtin___bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[u"fit_duration",u"gradients",u"loss",u"num_examples",u"num_examples_ceil",u"parameters"]) -> None: ...
        else:
            def HasField(self, field_name: typing_extensions___Literal[u"gradients",b"gradients",u"parameters",b"parameters"]) -> builtin___bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[u"fit_duration",b"fit_duration",u"gradients",b"gradients",u"loss",b"loss",u"num_examples",b"num_examples",u"num_examples_ceil",b"num_examples_ceil",u"parameters",b"parameters"]) -> None: ...
